...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col">
				<h1><b>MERCEDES BENZ</b></h1>
				<p style="color: #b7bcc4;"><b>Mercedes-Benz is known for producing luxury vehicles and commercial vehicles. The headquarters is in Stuttgart, Baden-Württemberg. The name first appeared in 1926 as Daimler-Benz. In 2018, Mercedes-Benz was the largest seller of premium vehicles in the world, having sold 2.31 million passenger cars.</p>
			</div>
			<div class="col">
				<a href="1benzc.php"><div class="card card1">
					<h5>MERCEDES-BENZ C-CLASS</h5>
				</div></a>
				<a href="1benzcls.php"><div class="card card2">
					<h5>MERCEDES-BENZ CLS-CLASS</h5>
				</div></a>
				<a href="1benzg63.php"><div class="card card3">
					<h5>MERCEDES-BENZ AMG G63</h5>
				</div></a>
				<a href="1benzgt.php"><div class="card card4">
					<h5>MERCEDES-BENZ AMG GT</h5>
				</div></a>
				<a href="1benzgle.php"><div class="card card5">
