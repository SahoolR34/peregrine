...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="heading">
      <h2> MERCEDES BENZ CLS-Class</h2>
    </div>
    <!-- Swiper -->
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/benzcls-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzcls-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzcls-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzcls-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzcls-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzcls-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzcls-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzcls-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzcls-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzcls-10.jpg" />
        </div>
      </div>
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">16/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">16/19 kmpl</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">17.4 gal.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">253.8/384.4 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              ...
              <li class="line1">
                ...
                <span class="val">56.4 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">196.3 in.</span>
              </li>
              <li class="line1">
                <span class="key">Width :</span>
                <span class="val">74.4 in.</span>
              </li>
              <li class="line0">
                <span class="key">Boot Space :</span>
                <span class="val">520 liters</span>
              </li>
            </ul>
        </div>
      </div>
    ...
    <div class="col">
      <h2>Related Search</h2>
        ...
        <a href="benzgt.php"><div class="card card4">
