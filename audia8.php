...
<html>
<head>
	<meta charset="utf-8">AUDI A8</title>
...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/audia8-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audia8-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audia8-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audia8-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audia8-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audia8-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audia8-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audia8-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audia8-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audia8-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$86,500</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">11.7/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">8.79/13.2 kmpl</span>
              </li>
              <li class="line0">
        ...
        <div class="content">
          <ul>
              ...
              <li class="line1">
                ...
                <span class="val">58.4 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">208.7 in.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">505 liters</span>
              </li>
            </ul>
        </div>
      </div>
    ...
    <div class="col">
      <h2>Related Search</h2>
        ...
        <a href="audirs7.php"><div class="card card3">
          <h5>AUDI RS7 Sportsback</h5>
        </div></a>
