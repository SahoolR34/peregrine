...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/toyotalc-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotalc-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotalc-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotalc-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotalc-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotalc-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotalc-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotalc-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotalc-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotalc-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$85,665</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
         <ul>
              ...
              <li class="line1">
                ...
                <span class="val">13/17 kmph</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">24.5 gal.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">278.4/382.7 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">5851 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">7385 lbs.</span>
              </li>
              <li class="line0">
              ...
              <li class="line1">
                ...
                <span class="val">74.0 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">193.9 in.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">1160 liters</span>
              </li>
            </ul>
        </div>
      </div>
