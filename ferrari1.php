...
.container{
	width: 100%;
	height: 100vh;
	background-image: linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.7)), url(images/5-5.png);
...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col">
				<h1><b>FERRARI</b></h1>
				<p style="color: #b7bcc4;"><b>Ferrari S.p.A. is an Italian luxury sports car manufacturer based in Maranello, Italy. Founded by Enzo Ferrari in 1939 out of the Alfa Romeo race division as Auto Avio Costruzioni, the company built its first car in 1940, and produced its first Ferrari-badged car in 1947.</p>
			</div>
			<div class="col">
				<a href="1ferrari488.php"><div class="card card1">
					<h5>FERRARI 488 Pista</h5>
				</div></a>
				<a href="1ferrariroma.php"><div class="card card2">
					<h5>FERRARI Roma</h5>
				</div></a>
				<a href="1ferrarifxxk.php"><div class="card card3">
					<h5>LA FERRARI FXXK EVO</h5>
				</div></a>
				<a href="1ferrarif8.php"><div class="card card4">
					<h5>FERRARI F8 Tributo</h5>
				</div></a>
				<a href="1ferrari812.php"><div class="card card5">
