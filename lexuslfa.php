...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/lexuslfa-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexuslfa-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexuslfa-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexuslfa-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexuslfa-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexuslfa-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexuslfa-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexuslfa-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexuslfa-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexuslfa-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$430,000</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">13/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">11/16 mpg</span>
              </li>
              <li class="line0">
              ...
              <li class="line0">
                ...
                <span class="val">263.7/345.1 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">3248.1 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">3589.1 lbs.</span>
              </li>
              <li class="line0">
                <span class="key">Ground Clearance :</span>
                <span class="val">4.4 in.</span>
              </li>
              <li class="line1">
                <span class="key">Height :</span>
                <span class="val">48.0 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">177.3 in.</span>
              </li>
              <li class="line1">
    ...
    <div class="col">
     <h2>Related Search</h2>
        <a href="lexusls.php"><div class="card card4">
          <h5>LEXUS LS</h5>
        </div></a>
