...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/ferrarif8-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrarif8-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrarif8-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrarif8-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrarif8-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrarif8-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrarif8-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrarif8-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrarif8-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrarif8-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$276,550</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">17.8/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">15/19 kmph</span>
              </li>
              <li class="line0">
              ...
              <li class="line0">
                ...
                <span class="val">268.7/371.9 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">3163 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">3164 lbs.</span>
              </li>
              <li class="line0">
                <span class="key">Ground Clearance :</span>
                <span class="val">7.1 in.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">181.5 in.</span>
              </li>
              <li class="line1">
                <span class="key">Width :</span>
                <span class="val">77.9 in.</span>
              </li>
              <li class="line0">
                <span class="key">Boot Space :</span>
                <span class="val">200 liters</span>
              </li>
            </ul>
        </div>
      </div>
