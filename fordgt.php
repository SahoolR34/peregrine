...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/fordgt-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordgt-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordgt-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordgt-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordgt-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordgt-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordgt-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordgt-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordgt-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordgt-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$500,000</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">Sports Car coupe</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">7-speed dual clutch Automatic with Manual</span>
              </li>
              <li class="line1">
        ...
        <div class="content">
         <ul>
              ...
              <li class="line1">
                ...
                <span class="val">11/18 kmph</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">15.3 gal.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">223.5/318.3 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">3381 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">3493 lbs.</span>
              </li>
              <li class="line0">
                <span class="key">Ground Clearance :</span>
                <span class="val">7.3 in.</span>
              </li>
              <li class="line1">
                <span class="key">Height :</span>
                <span class="val">43.7 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">187.4 in.</span>
              </li>
              <li class="line1">
                <span class="key">Width :</span>
                <span class="val">78.8 in.</span>
              </li>
              <li class="line0">
                <span class="key">Boot Space :</span>
                <span class="val">11 liters</span>
              </li>
            </ul>
        </div>
      </div>
