...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/lexuslx-0.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexuslx-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexuslx-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexuslx-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexuslx-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexuslx-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexuslx-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexuslx-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexuslx-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexuslx-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$91,830</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">16.9/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">13/18 mpg</span>
              </li>
              <li class="line0">
              ...
              <li class="line0">
                ...
                <span class="val">296.2/392.4 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">5864.2 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">7495.7 lbs.</span>
              </li>
              <li class="line0">
              ...
              <li class="line0">
                ...
                <span class="val">349 liters</span>
              </li>
            </ul>
        </div>
      </div>
