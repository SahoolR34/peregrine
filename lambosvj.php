...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/lambosvj-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lambosvj-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lambosvj-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lambosvj-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lambosvj-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lambosvj-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lambosvj-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lambosvj-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lambosvj-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lambosvj-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$573,966</h1></div>
    <div class="accordion">
      <div class="contentBx">
