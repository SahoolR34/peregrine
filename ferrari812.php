...
<head>
	<meta charset="utf-8">
	<title>FERRARI 812 COMPETIZIONE</title>
...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="heading">
      <h2>FERRARI 812 COMPETIZIONE</h2>
    </div>
    <!-- Swiper -->
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/ferrari812-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrari812-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrari812-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrari812-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrari812-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrari812-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrari812-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrari812-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrari812-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrari812-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$600,000</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
          <ul>
              ...
              <li class="line0">
                ...
                <span class="val">7-speed Automatic</span>
              </li>
              <li class="line1">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">7/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">4.2/8.7 kmph</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">24.3 gal.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">210.1/305.2 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">3278 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">3510 lbs.</span>
              </li>
              <li class="line0">
                <span class="key">Ground Clearance :</span>
                <span class="val">4.7 in.</span>
              </li>
              <li class="line1">
                <span class="key">Height :</span>
                <span class="val">50.3 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">184.8 in.</span>
              </li>
              <li class="line1">
                <span class="key">Width :</span>
                <span class="val">77.5 in.</span>
              </li>
              <li class="line0">
                <span class="key">Boot Space :</span>
                <span class="val">210 liters</span>
              </li>
            </ul>
        </div>
      </div>
    ...
    <div class="col">
     <h2>Related Search</h2>
        ...
        <a href="ferrarifxxk.php"><div class="card card3">
          <h5>LA FERRARI FXXK EVO</h5>
        </div></a>
