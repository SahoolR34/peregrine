...
<html>
<head>
	<meta charset="utf-8">AUDI S7 Sportback</title>
...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="heading">
      <h2>AUDI S7 Sportback</h2>
    </div>
    <!-- Swiper -->
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/audis7-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audis7-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audis7-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audis7-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audis7-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audis7-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audis7-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audis7-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audis7-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audis7-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$84,400</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">4717.8 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">6029.6 lbs.</span>
              </li>
              <li class="line0">
              ...
              <li class="line1">
                ...
                <span class="val">57.1 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">197.2 in.</span>
              </li>
              <li class="line1">
                <span class="key">Width :</span>
                <span class="val">83.3 in.</span>
              </li>
              <li class="line0">
