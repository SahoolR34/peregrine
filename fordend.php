...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/fordend-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordend-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordend-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordend-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordend-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordend-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordend-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordend-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordend-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordend-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$47,095</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">13.9/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">9.35/15.2 kmph</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">21.3 gal.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">272.7/383.9 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">5038 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">5325 lbs.</span>
              </li>
              <li class="line0">
                <span class="key">Ground Clearance :</span>
                <span class="val">8.8 in.</span>
              </li>
              <li class="line1">
                <span class="key">Height :</span>
                <span class="val">72.3 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">193.0 in.</span>
              </li>
              <li class="line1">
                <span class="key">Width :</span>
                <span class="val">73.5 in.</span>
              </li>
              <li class="line0">
                <span class="key">Boot Space :</span>
                <span class="val">450 liters</span>
              </li>
            </ul>
        </div>
      </div>
