...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/benzg63-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzg63-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzg63-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzg63-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzg63-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzg63-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzg63-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzg63-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzg63-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzg63-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$156,450</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
          <ul>
              ...
              <li class="line0">
                ...
                <span class="val">7-speed automatatic</span>
              </li>
              <li class="line1">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">8/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">6.89/11.8 kmpl</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">25.3 gal.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">177.8/296.4 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">5621.7 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">7716.1 lbs.</span>
              </li>
              <li class="line0">
              ...
              <li class="line0">
                ...
                <span class="val">480 liters</span>
              </li>
            </ul>
        </div>
      </div>
