...
<head>
	<meta charset="utf-8">
	<title>FORD MUSTANG GT500</title>
...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="heading">
      <h2>FORD MUSTANG GT500</h2>
    </div>
    <!-- Swiper -->
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/ford500-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ford500-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ford500-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ford500-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ford500-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ford500-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ford500-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ford500-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ford500-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ford500-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$70,300</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
          <ul>
              ...
              <li class="line0">
                ...
                <span class="val">7-speed dual clutch Automatic</span>
              </li>
              <li class="line1">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">14/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">12/18kmph</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">16.1 gal.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">278.3/373.2 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">4171 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">4080 lbs.</span>
              </li>
              <li class="line0">
              ...
              <li class="line1">
                ...
                <span class="val">53.9 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">189.4 in.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">408 liters</span>
              </li>
            </ul>
        </div>
      </div>
    ...
    <div class="col">
     <h2>Related Search</h2>
        ...
        <a href="fordeco.php"><div class="card card4">
