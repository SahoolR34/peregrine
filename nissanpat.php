...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/nissanpat-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissanpat-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissanpat-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissanpat-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissanpat-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissanpat-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissanpat-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissanpat-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissanpat-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissanpat-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$105,000</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">15/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">12.6/17.3 kmph</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">15.8 gal.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">282.8/361.2 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">5192 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">6835 lbs.</span>
              </li>
              <li class="line0">
                <span class="key">Ground Clearance :</span>
                <span class="val">10.7 in.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">668 liters</span>
              </li>
            </ul>
        </div>
      </div>
