                  ...
                  <thead>
                    <tr>
                     ...
                     <?php 
                      ...
                      $sql = mysqli_query($con,"SELECT * from car_info");
                      ...
                      $sql1 = mysqli_query($con,"SELECT * from car_info2 where `car_modal`='$res[car_modal]'");
                       while($res1=mysqli_fetch_array($sql1)){
                         ?>
                           <td><?php echo $res1['car_qty'];?></td>
                           <td><?php echo $res['car_price'];?></td>
                           <td><a href="book.php?id=<?php echo $_SESSION['umail'];?>&umd=<?php echo $res['car_modal'];?>"><i class="fas fa-check-square"></i></td>
                         <?php
                       }
                      }
                     ?>
