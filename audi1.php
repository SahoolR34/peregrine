...
.container{
	width: 100%;
	height: 100vh;
	background-image: linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.7)), url(images/3.png);
...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col">
				<h1><b>Audi</b></h1>
				<p style="color: #b7bcc4;"><b>Audi AG is a German automobile manufacturer that designs, engineers, produces, markets and distributes luxury vehicles. Audi is a subsidiary of Volkswagen Group and has its roots at Ingolstadt, Bavaria, Germany. Audi vehicles are produced in nine production facilities worldwide.</p>
			</div>
			<div class="col">
				<a href="1audir8.php"><div class="card card1">
					<h5>AUDI R8</h5>
				</div></a>
				<a href="1audiq8.php"><div class="card card2">
					<h5>AUDI Q8</h5>
				</div></a>
				<a href="1audirs7.php"><div class="card card3">
					<h5>AUDI RS7 Sportsback</h5>
				</div></a>
				<a href="1audia8.php"><div class="card card4">
					<h5>AUDI A8</h5>
				</div></a>
				<a href="1audis7.php"><div class="card card5">
