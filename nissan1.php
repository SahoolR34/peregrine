...
.container{
	width: 100%;
	height: 100vh;
	background-image: linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.7)), url(images/7-7.png);
...
<body>
	<div id="loader">
		<img src="images/nisssanload.gif">
	</div>
	<div id="content">
	<div class="container">
		<div class="wrapper">
		...
		<div class="row">
			<div class="col">
				<h1><b>NISSAN</b></h1>
				<p style="color: #b7bcc4;"><b>The Nissan Motor Company, Ltd. is a Japanese multinational automobile manufacturer headquartered in Nishi-ku, Yokohama, Japan. The company sells its vehicles under the Nissan, Infiniti, and Datsun brands. The company traces its name to the Nissan zaibatsu, now called Nissan Group.</p>
			</div>
			<div class="col">
				<a href="1nissantitan.php"><div class="card card1">
					<h5>NISSAN Titan</h5>
				</div></a>
				<a href="1nissangtr.php"><div class="card card2">
					<h5>NISSAN GTR</h5>
				</div></a>
				<a href="1nissanpat.php"><div class="card card3">
					<h5>NISSAN Patrol</h5>
				</div></a>
				<a href="1nissanalt.php"><div class="card card4">
					<h5>NISSAN Altima</h5>
				</div></a>
				<a href="1nissan370.php"><div class="card card5">
					<h5>NISSAN 370Z</h5>
				</div></a>
			</div>
		</div>
