...
<head>
	<meta charset="utf-8">
	<title>LAFERRARI FXXK EVO </title>
...
.card1{
  background-image: url(images/ferrari488.jpg);
}
.card2{
  background-image: url(images/ferrariroma.jpg);
}
.card3{
  background-image: url(images/ferrarifxxk.jpg);
}
.card4{
  background-image: url(images/ferrarif8.jpg);
}
.card5{
  background-image: url(images/ferrari812.jpg);
}
.card:hover{
...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="heading">
      <h2>LAFERRARI FXXK EVO</h2>
    </div>
    <!-- Swiper -->
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/ferrarifxxk-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrarifxxk-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrarifxxk-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrarifxxk-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrarifxxk-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrarifxxk-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrarifxxk-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrarifxxk-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrarifxxk-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrarifxxk-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$2,600,000</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
          <ul>
              ...
              <li class="line1">
                ...
                <span class="val">Inline 12</span>
              </li>
              <li class="line0">
                <span class="key">Transmission :</span>
                <span class="val">7-speed F1 dual clutch</span>
              </li>
              <li class="line1">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">6/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">3/6.9 kmph</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">13.7 gal.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">245.3/358.7 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">3304 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">3500.8 lbs.</span>
              </li>
              <li class="line0">
                <span class="key">Ground Clearance :</span>
                <span class="val">4.5 in.</span>
              </li>
              <li class="line1">
                <span class="key">Height :</span>
                <span class="val">50.9 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">172.5 in.</span>
              </li>
              <li class="line1">
                <span class="key">Width :</span>
                <span class="val">73.0 in.</span>
              </li>
              <li class="line0">
                <span class="key">Boot Space :</span>
                <span class="val">290 liters</span>
              </li>
            </ul>
        </div>
      </div>
    ...
    <div class="col">
     <h2>Related Search</h2>
        <a href="ferrari488.php"><div class="card card1">
          <h5>FERRARI 488 Pista</h5>
        </div></a>
        <a href="ferrariroma.php"><div class="card card2">
          <h5>FERRARI Roma</h5>
        </div></a>
        <a href="ferrarif8.php"><div class="card card4">
          <h5>FERRARI F8 Tributo</h5>
        </div></a>
        <a href="ferrari812.php"><div class="card card5">
          <h5>FERRARI 812 COMPETIZIONE</h5>
        </div></a>
      </div>
    </div>
<footer>
