...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/lexusls-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexusls-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexusls-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexusls-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexusls-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexusls-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexusls-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexusls-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexusls-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lexusls-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$76,000</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">15.4/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">11.7/17.1 mpg</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">21.6 gal.</span>
              </li>
              <li class="line1">
                <span class="key">Fuel Type :</span>
                <span class="val">HYBRID + Premium unleaded (required)</span>
              </li>
              <li class="line0">
                <span class="key">Range in Miles (Cty/Hwy) :</span>
                <span class="val">289.8/379.4 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">5026.5 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">6007.5 lbs.</span>
              </li>
              <li class="line0">
                <span class="key">Ground Clearance :</span>
                <span class="val">5.7 in.</span>
              </li>
              <li class="line1">
                <span class="key">Height :</span>
                <span class="val">57.0 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">206.1 in.</span>
              </li>
              <li class="line1">
                <span class="key">Width :</span>
                <span class="val">74.8 in.</span>
              </li>
              <li class="line0">
                <span class="key">Boot Space :</span>
                <span class="val">430 liters</span>
              </li>
            </ul>
        </div>
      </div>
    ...
    <div class="col">
     <h2>Related Search</h2>
        <a href="lexuslx.php"><div class="card card5">
          <h5>LEXUS LX</h5>
        </div></a>
        <a href="lexuslfa.php"><div class="card card6">
          <h5>LEXUS LFA</h5>
        </div></a>
      </div>
    </div>
