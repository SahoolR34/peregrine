...
.card2{
  background-image: url(images/bmwz4.jpg);
}
.card3{
  background-image: url(images/bmwx7.jpg);
}
.card4{
  background-image: url(images/bmw8s.jpg);
}
.card5{
...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/bmwi8-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwi8-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwi8-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwi8-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwi8-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwi8-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwi8-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwi8-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwi8-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwi8-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$147,500</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">Hybrid Sports</span>
              </li>
              <li class="line1">
                <span class="key">Engine Type :</span>
                <span class="val">Hybrid petrol</span>
              </li>
              <li class="line0">
                <span class="key">Drive Type :</span>
                <span class="val">4 wheel Drive</span>
              </li>
              <li class="line1">
                <span class="key">Cylinders:</span>
                <span class="val">Inline 3</span>
              </li>
              <li class="line0">
                <span class="key">Transmission :</span>
                <span class="val">6-speed</span>
              </li>
              <li class="line1">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">47.45/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">47.45/47.45 mpg</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">11.0 gal.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">500 km (310 mi) in Comfort mode (NEDC) 600 km (370 mi) in Eco Pro mode (NEDC) 530 km (330 mi) (EPA)</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">3,394 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">4190 lbs.</span>
              </li>
              <li class="line0">
                <span class="key">Ground Clearance :</span>
                <span class="val">4.6 in.</span>
              </li>
              <li class="line1">
                <span class="key">Height :</span>
                <span class="val">51.1 in.</span>
              </li>
              <li class="line0">
              ...
              <li class="line1">
                ...
                <span class="val">76.5 in.</span>
              </li>
              <li class="line0">
                <span class="key">Boot Space :</span>
                <span class="val">154 liters</span>
              </li>
            </ul>
        </div>
      </div>
    ...
    <div class="col">
     <h2>Related Search</h2>
        <a href="bmwm4.php"><div class="card card1">
          <h5>B.M.W M4 GTS</h5>
        </div></a>
        <a href="bmwz4.php"><div class="card card2">
          <h5>B.M.W Z4</h5>
        </div></a>
        <a href="bmwx7.php"><div class="card card3">
          <h5>B.M.W X7</h5>
        </div></a>
        <a href="bmw8s.php"><div class="card card4">
          <h5>B.M.W 8 Series</h5>
        </div></a>
      </div>
    </div>
<footer>
