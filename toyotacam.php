...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/toyotacam-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotacam-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotacam-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotacam-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotacam-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotacam-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotacam-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotacam-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotacam-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotacam-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$32,185</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">19.16/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">14.29/21.49 kmph</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">13.2 gal.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">282.0/399.2 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">3670 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">4629.7 lbs.</span>
              </li>
              <li class="line0">
                <span class="key">Ground Clearance :</span>
                <span class="val">6.2 in.</span>
              </li>
              <li class="line1">
                <span class="key">Height :</span>
                <span class="val">57.2 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">192.3 in.</span>
              </li>
              <li class="line1">
                <span class="key">Width :</span>
                <span class="val">72.4 in.</span>
              </li>
              <li class="line0">
                <span class="key">Boot Space :</span>
                <span class="val">587 liters</span>
              </li>
            </ul>
        </div>
      </div>
    ...
    <div class="col">
     <h2>Related Search</h2>
        <a href="toyotalc.php"><div class="card card1">
          <h5>TOYOTA Land Cruiser</h5>
        </div></a>
        <a href="toyotas.php"><div class="card card3">
          <h5>TOYOTA Supra</h5>
        </div></a>
      </div>
    </div>
