...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/nissangtr-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissangtr-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissangtr-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissangtr-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissangtr-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissangtr-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissangtr-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissangtr-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissangtr-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissangtr-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$210,740</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
          <ul>
              ...
              <li class="line1">
                ...
                <span class="val">Inline 6</span>
              </li>
              <li class="line0">
                <span class="key">Transmission :</span>
                <span class="val">6-speed dual clutch Automatic with Manual shifting mode</span>
              </li>
              <li class="line1">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">18/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">16/22 kmph</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">19.5 gal.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">263.8/374.3 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">3865 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">4727 lbs.</span>
              </li>
              <li class="line0">
                <span class="key">Ground Clearance :</span>
                <span class="val">3.9 in.</span>
              </li>
              <li class="line1">
                <span class="key">Height :</span>
                <span class="val">53.8 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">184.6 in.</span>
              </li>
              <li class="line1">
                <span class="key">Width :</span>
                <span class="val">74.6 in.</span>
              </li>
              <li class="line0">
                <span class="key">Boot Space :</span>
                <span class="val">225 liters</span>
              </li>
            </ul>
        </div>
      </div>
    ...
    <div class="col">
     <h2>Related Search</h2>
        ...
        <a href="nissanalt.php"><div class="card card4">
          <h5>NISSAN Altima</h5>
        </div></a>
