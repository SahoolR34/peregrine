...
<html>
<head>
	<meta charset="utf-8">AUDI R8</title>
...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/audir8-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audir8-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audir8-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audir8-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audir8-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audir8-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audir8-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audir8-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audir8-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audir8-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$208,100</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
          <ul>
              ...
              <li class="line1">
                ...
                <span class="val">Inline 10</span>
              </li>
              <li class="line0">
                <span class="key">Transmission :</span>
                <span class="val">7-speed DL501 S-Tronic dual-clutch</span>
              </li>
              <li class="line1">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">6.71/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">5.3/8.2 kmpl</span>
              </li>
              <li class="line0">
              ...
              <li class="line0">
                ...
                <span class="val">175/250 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              ...
              <li class="line1">
                ...
                <span class="val">49.3 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">176.6 in.</span>
              </li>
              <li class="line1">
                <span class="key">Width :</span>
                <span class="val">76.0 in.</span>
              </li>
              <li class="line0">
                <span class="key">Boot Space :</span>
                <span class="val">112 liters</span>
              </li>
            </ul>
        </div>
      </div>
