...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/bmw8s-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmw8s-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmw8s-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmw8s-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmw8s-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmw8s-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmw8s-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmw8s-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmw8s-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmw8s-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$109,895</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">11.3/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">8.5/12.5 mpg</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">17.9 gal.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">306/450 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">4133 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">4563 lbs.</span>
              </li>
              <li class="line0">
                <span class="key">Ground Clearance :</span>
                <span class="val">5.0 in.</span>
              </li>
              <li class="line1">
                <span class="key">Height :</span>
                <span class="val">55.3 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">200.0 in.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">440 liters</span>
              </li>
            </ul>
        </div>
      </div>
