...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/benzc-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzc-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzc-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzc-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzc-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzc-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzc-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzc-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzc-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzc-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$41,400</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
          <ul>
              ...
              <li class="line0">
                ...
                <span class="val">9-speed automated manual</span>
              </li>
              <li class="line1">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">12/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">15.45/19.71 kmpl</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">10.8 gal.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">243.8/356.4 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              ...
              <li class="line1">
                ...
                <span class="val">56.7 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">184.4 in.</span>
              </li>
              <li class="line1">
                <span class="key">Width :</span>
                <span class="val">71.2 in.</span>
              </li>
              <li class="line0">
