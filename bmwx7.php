...
@media (max-width: 991px)
{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/bmwx7-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwx7-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwx7-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwx7-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwx7-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwx7-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwx7-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwx7-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwx7-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwx7-10.jpg" />
        </div>
      </div>
  ...
  <script>
    ...
    <div class="price"><h1>$99,800</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">10.5/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">19/24 mpg</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">21.9 gal.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">260/372 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">5370 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">6989 lbs.</span>
              </li>
              <li class="line0">
                <span class="key">Ground Clearance :</span>
                <span class="val">8.7 in.</span>
              </li>
              <li class="line1">
                <span class="key">Height :</span>
                <span class="val">71.1 in.</span>
              </li>
              <li class="line0">
              ...
              <li class="line1">
                ...
                <span class="val">78.7 in.</span>
              </li>
              <li class="line0">
                <span class="key">Boot Space :</span>
                <span class="val">326 liters</span>
              </li>
            </ul>
        </div>
      </div>
