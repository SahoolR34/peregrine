...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/ferrariroma-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrariroma-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrariroma-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrariroma-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrariroma-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrariroma-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrariroma-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrariroma-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrariroma-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrariroma-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$222,630</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
          <ul>
              ...
              <li class="line0">
                ...
                <span class="val">8-speed Dual Clutch</span>
              </li>
              <li class="line1">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">19/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">17/22 kmph</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">21.1 gal.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">267.3/349.7 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">3461 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">3637.3 lbs.</span>
              </li>
              <li class="line0">
              ...
              <li class="line1">
                ...
                <span class="val">51.2 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">183.3 in.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">272 liters</span>
              </li>
            </ul>
        </div>
      </div>
