...
<html>
<head>
	<meta charset="utf-8">AUDI Q8</title>
...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/audiq8-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audiq8-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audiq8-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audiq8-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audiq8-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audiq8-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audiq8-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audiq8-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audiq8-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audiq8-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$69,300</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">9.8/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">7/10 kmpl</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">22.4 gal.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">295.4/347.2 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">4662.7 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">6239.1 lbs.</span>
              </li>
              <li class="line0">
                <span class="key">Ground Clearance :</span>
                <span class="val">10 in.</span>
              </li>
              <li class="line1">
                <span class="key">Height :</span>
                <span class="val">67.1 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">196.2 in.</span>
              </li>
              <li class="line1">
                <span class="key">Width :</span>
                <span class="val">78.5 in.</span>
              </li>
              <li class="line0">
                <span class="key">Boot Space :</span>
                <span class="val">605 liters</span>
              </li>
            </ul>
        </div>
      </div>
