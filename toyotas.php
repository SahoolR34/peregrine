...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/toyotas-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotas-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotas-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotas-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotas-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotas-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotas-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotas-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotas-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/toyotas-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$56,825</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">Sports hatchback</span>
              </li>
              <li class="line1">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">10.63/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">9.35/13.6 kmph</span>
              </li>
              <li class="line0">
    ...
    <div class="col">
     <h2>Related Search</h2>
        ...
        <a href="toyotacam.php"><div class="card card2">
          <h5>TOYOTA Camry</h5>
        </div></a>
      </div>
    </div>
