...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/lambourus-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lambourus-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lambourus-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lambourus-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lambourus-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lambourus-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lambourus-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lambourus-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lambourus-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lambourus-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$239,231</h1></div>
    <div class="accordion">
      <div class="contentBx">
