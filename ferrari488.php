...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/ferrari488-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrari488-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrari488-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrari488-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrari488-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrari488-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrari488-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrari488-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrari488-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ferrari488-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$330,000</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">2 door coupe</span>
              </li>
              <li class="line1">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">18.63/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">15/20 kmph</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">20.6 gal.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">212.7/343.9 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">3241 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">3053 lbs.</span>
              </li>
              <li class="line0">
                <span class="key">Ground Clearance :</span>
                <span class="val">4.3 in.</span>
              </li>
              <li class="line1">
                <span class="key">Height :</span>
                <span class="val">47.4 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">181.2 in.</span>
              </li>
              <li class="line1">
                <span class="key">Width :</span>
                <span class="val">77.7 in.</span>
              </li>
              <li class="line0">
                <span class="key">Boot Space :</span>
                <span class="val">170 liters</span>
              </li>
            </ul>
        </div>
      </div>
