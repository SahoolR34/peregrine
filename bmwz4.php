...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/bmwz4-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwz4-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwz4-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwz4-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwz4-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwz4-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwz4-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwz4-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwz4-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwz4-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$63,700</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
          <ul>
              ...
              <li class="line0">
                ...
                <span class="val">8-speed automated manual</span>
              </li>
              <li class="line1">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">27/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">24/32 mpg</span>
              </li>
              <li class="line0">
              ...
              <li class="line1">
                ...
                <span class="val">Premium unleaded (recommended)</span>
              </li>
              <li class="line0">
                <span class="key">Range in Miles (Cty/Hwy) :</span>
                <span class="val">328.8/438.4 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">3287 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">3867 lbs.</span>
              </li>
              <li class="line0">
              ...
              <li class="line1">
                ...
                <span class="val">51.4 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">170.7 in.</span>
              </li>
              <li class="line1">
                <span class="key">Width :</span>
                <span class="val">73.4 in.</span>
              </li>
              <li class="line0">
                <span class="key">Boot Space :</span>
                <span class="val">281 liters</span>
              </li>
            </ul>
        </div>
      </div>
    ...
    <div class="col">
     <h2>Related Search</h2>
        ...
        <a href="bmwi8.php"><div class="card card5">
          <h5>B.M.W i8</h5>
        </div></a>
      </div>
    </div>
