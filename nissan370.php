...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/nissan370-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissan370-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissan370-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissan370-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissan370-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissan370-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissan370-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissan370-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissan370-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissan370-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$30,090</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
          <ul>
              ...
              <li class="line0">
                ...
                <span class="val">Front wheel Drive</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">6-speed Manual</span>
              </li>
              <li class="line1">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">11/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">8/12.9 kmph</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">19.0 gal.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">248.39/325.9 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">3464 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">3968 lbs.</span>
              </li>
              <li class="line0">
              ...
              <li class="line1">
                ...
                <span class="val">51.7 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">167.3 in.</span>
              </li>
              <li class="line1">
                <span class="key">Width :</span>
                <span class="val">72.6 in.</span>
              </li>
              <li class="line0">
                <span class="key">Boot Space :</span>
                <span class="val">195 liters</span>
              </li>
            </ul>
        </div>
      </div>
