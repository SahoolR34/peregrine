...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/lamboh-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lamboh-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lamboh-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lamboh-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lamboh-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lamboh-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lamboh-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lamboh-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lamboh-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/lamboh-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$210,180</h1></div>
    <div class="accordion">
      <div class="contentBx">
