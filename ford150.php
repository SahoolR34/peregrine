...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/ford150-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ford150-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ford150-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ford150-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ford150-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ford150-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ford150-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ford150-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ford150-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/ford150-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$65,840</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">Super Truck</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">10-speed Automatic</span>
              </li>
              <li class="line1">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">17/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">15/18 kmph</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">25.8 gal.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">390/572 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">5508 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">6650 lbs.</span>
              </li>
              <li class="line0">
                <span class="key">Ground Clearance :</span>
                <span class="val">9.8 in.</span>
              </li>
              <li class="line1">
                <span class="key">Height :</span>
                <span class="val">78.4 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">220 in.</span>
              </li>
              <li class="line1">
                <span class="key">Width :</span>
                <span class="val">86.2 in.</span>
              </li>
              <li class="line0">
                <span class="key">Boot Space :</span>
                <span class="val">855 liters</span>
              </li>
            </ul>
        </div>
      </div>
