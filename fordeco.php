...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="heading">
      <h2>FORD ECOSPORTS</h2>
    </div>
    <!-- Swiper -->
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/fordeco-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordeco-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordeco-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordeco-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordeco-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordeco-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordeco-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordeco-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordeco-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/fordeco-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$14,745</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
          <ul>
              ...
              <li class="line0">
                ...
                <span class="val">5-speed Manual</span>
              </li>
              <li class="line1">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">21.7/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">18.9/23.2 kmph</span>
              </li>
              <li class="line0">
              ...
              <li class="line0">
                ...
                <span class="val">230/290 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">2886 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">3726 lbs.</span>
              </li>
              <li class="line0">
                <span class="key">Ground Clearance :</span>
                <span class="val">7.5 in.</span>
              </li>
              <li class="line1">
                <span class="key">Height :</span>
                <span class="val">64.8 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">157.4 in.</span>
              </li>
              <li class="line1">
                <span class="key">Width :</span>
                <span class="val">69.4 in.</span>
              </li>
              <li class="line0">
                <span class="key">Boot Space :</span>
                <span class="val">352 liters</span>
              </li>
            </ul>
        </div>
      </div>
    ...
    <div class="col">
     <h2>Related Search</h2>
        <a href="ford150.php"><div class="card card1">
          <h5>FORD Raptor F150</h5>
        </div></a>
        <a href="fordend.php"><div class="card card2">
          <h5>FORD Endeavour</h5>
        </div></a>
        <a href="ford500.php"><div class="card card3">
          <h5>FORD Mustang GT500</h5>
        </div></a>
        <a href="fordgt.php"><div class="card card5">
          <h5>FORD GT</h5>
        </div></a>
      </div>
    </div>
