...
<html>
<head>
	<meta charset="utf-8">AUDI RS7 Sportback</title>
...
.card2{
  background-image: url(images/audiq8.jpg);
}
.card3{
  background-image: url(images/audirs7.jpg);
}
.card4{
  background-image: url(images/audia8.jpg);
}
.card5{
  background-image: url(images/audis7.jpg);
}
.card:hover{
...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="heading">
      <h2>AUDI RS7 Sportback</h2>
    </div>
    <!-- Swiper -->
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/audirs7-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audirs7-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audirs7-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audirs7-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audirs7-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audirs7-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audirs7-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audirs7-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audirs7-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/audirs7-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$95,900</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
          <ul>
              ...
              <li class="line0">
                ...
                <span class="val">8-speed Automatic</span>
              </li>
              <li class="line1">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">8.9/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">5.3/9.8 kmpl</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">19.4 gal.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">265.4/332.8 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">4475.3 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">6073.7 lbs.</span>
              </li>
              <li class="line0">
                <span class="key">Ground Clearance :</span>
                <span class="val">4.9 in.</span>
              </li>
              <li class="line1">
                <span class="key">Height :</span>
                <span class="val">56.0 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">197.7 in.</span>
              </li>
              <li class="line1">
                <span class="key">Width :</span>
                <span class="val">76.7 in.</span>
              </li>
              <li class="line0">
                <span class="key">Boot Space :</span>
                <span class="val">535 liters</span>
              </li>
            </ul>
        </div>
      </div>
    ...
    <div class="col">
      <h2>Related Search</h2>
        <a href="audir8.php"><div class="card card1">
          <h5>AUDI R8</h5>
        </div></a>
        <a href="audiq8.php"><div class="card card2">
          <h5>AUDI Q8</h5>
        </div></a>
        <a href="audia8.php"><div class="card card4">
          <h5>AUDI A8</h5>
        </div></a>
        <a href="audis7.php"><div class="card card5">
          <h5>AUDI S7 Sportsback</h5>
        </div></a>
      </div>
    </div>
<footer>
