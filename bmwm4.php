...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/bmwm4-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwm4-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwm4-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwm4-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwm4-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwm4-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwm4-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwm4-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwm4-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/bmwm4-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$133,205</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
          <ul>
              ...
              <li class="line0">
                ...
                <span class="val">7-speed automated manual</span>
              </li>
              <li class="line1">
        ...
        <div class="content">
         <ul>
              ...
              <li class="line0">
                ...
                <span class="val">252.8/363.4 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              ...
              <li class="line1">
                ...
                <span class="val">76.6 in.</span>
              </li>
              <li class="line0">
                <span class="key">Boot Space :</span>
                <span class="val">368 liters</span>
              </li>
            </ul>
        </div>
      </div>
