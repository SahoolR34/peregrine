...
.card1{
  background-image: url(images/nissantitan.jpg);
}
.card2{
  background-image: url(images/nissangtr.jpg);
}
.card3{
  background-image: url(images/nissanpatrol.jpg);
}
.card4{
  background-image: url(images/nissanaltima.jpg);
}
.card5{
  background-image: url(images/nissan370z.jpg);
}
.card:hover{
...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/nissanalt-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissanalt-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissanalt-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissanalt-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissanalt-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissanalt-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissanalt-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissanalt-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissanalt-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissanalt-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$29,990</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
          <ul>
              ...
              <li class="line0">
                ...
                <span class="val">All wheel Drive</span>
              </li>
              <li class="line1">
                <span class="key">Cylinders :</span>
                <span class="val">Inline 4</span>
              </li>
              <li class="line0">
                <span class="key">Transmission :</span>
                <span class="val">6-speed Automatic</span>
              </li>
              <li class="line1">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">29/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">25/35 kmph</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">15 gal.</span>
              </li>
              <li class="line1">
              ...
              <li class="line0">
                ...
                <span class="val">285.7/387.4 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">3429 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">4328 lbs.</span>
              </li>
              <li class="line0">
                <span class="key">Ground Clearance :</span>
                <span class="val">4.0 in.</span>
              </li>
              <li class="line1">
                <span class="key">Height :</span>
                <span class="val">57.4 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">192.9 in.</span>
              </li>
              <li class="line1">
                <span class="key">Width :</span>
                <span class="val">72.9 in.</span>
              </li>
              <li class="line0">
                <span class="key">Boot Space :</span>
                <span class="val">425 liters</span>
              </li>
            </ul>
        </div>
      </div>
    ...
    <div class="col">
     <h2>Related Search</h2>
        <a href="nissantitan.php"><div class="card card1">
          <h5>NISSAN Titan</h5>
        </div></a>
        <a href="nissangtr.php"><div class="card card2">
          <h5>NISSAN GTR</h5>
        </div></a>
        <a href="nissanpat.php"><div class="card card3">
          <h5>NISSAN Patrol</h5>
        </div></a>
        <a href="nissan370.php"><div class="card card5">
          <h5>NISSAN 370Z</h5>
        </div></a>
      </div>
    </div>
