...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/nissantitan-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissantitan-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissantitan-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissantitan-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissantitan-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissantitan-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissantitan-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissantitan-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissantitan-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/nissantitan-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$65,490</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">Pickup Truck</span>
              </li>
              <li class="line1">
        ...
        <div class="content">
         <ul>
              ...
              <li class="line1">
                ...
                <span class="val">16/21 kmph</span>
              </li>
              <li class="line0">
                <span class="key">Fuel tank Capacity :</span>
                <span class="val">26 gal.</span>
              </li>
              <li class="line1">
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">5537 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">7100 lbs.</span>
              </li>
              <li class="line0">
                <span class="key">Ground Clearance :</span>
                <span class="val">8.5 in.</span>
              </li>
              <li class="line1">
                <span class="key">Height :</span>
                <span class="val">75.1 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">228.1 in.</span>
              </li>
              <li class="line1">
                <span class="key">Width :</span>
                <span class="val">79.5 in.</span>
              </li>
              <li class="line0">
