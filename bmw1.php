...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col">
				<h1><b>BMW</b></h1>
				<p style="color: #b7bcc4;"><b>Bayerische Motoren Werke AG,<br> commonly known as Bavarian Motor Works,<br> BMW or BMW AG, is a German automobile,<b>motorcycle and engine manufacturing company founded in 1916. BMW is headquartered in Munich, Bavaria. It also owns and produces Mini cars, and is the parent company of Rolls-Royce Motor Cars.</p>
			</div>
			<div class="col">
				<a href="1bmwm4.php"><div class="card card1">
					<h5>B.M.W M4 GTS</h5>
				</div></a>
				<a href="1bmwz4.php"><div class="card card2">
					<h5>B.M.W Z4</h5>
				</div></a>
				<a href="1bmwx7.php"><div class="card card3">
					<h5>B.M.W X7</h5>
				</div></a>
				<a href="1bmw8s.php"><div class="card card4">
					<h5>B.M.W 8 Series</h5>
				</div></a>
				<a href="1bmwi8.php"><div class="card card5">
					<h5>B.M.W i8</h5>
				</div></a>
			</div>
		</div>
