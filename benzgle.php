...
@media (max-width: 991px)
{
  ...
  .copyrightText{
    ...
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/benzgle-1.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzgle-2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzgle-3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzgle-4.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzgle-5.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzgle-6.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzgle-7.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzgle-8.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzgle-9.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="images/benzgle-10.jpg" />
        </div>
      </div>
    ...
    <div class="price"><h1>$116,000</h1></div>
    <div class="accordion">
      <div class="contentBx">
        ...
        <div class="content">
          <ul>
              ...
              <li class="line0">
                ...
                <span class="val">4-Matic All wheel Drive</span>
              </li>
              <li class="line1">
        ...
        <div class="content">
         <ul>
              <li class="line0">
                ...
                <span class="val">10.75/L</span>
              </li>
              <li class="line1">
                <span class="key">Mileage (Cty/Hwy) :</span>
                <span class="val">11/14 kmpl</span>
              </li>
              <li class="line0">
              ...
              <li class="line0">
                ...
                <span class="val">263.7/385.3 mi.</span>
              </li>
            </ul>
        </div>
      </div>
        ...
        <div class="content">
          <ul>
              <li class="line0">
                ...
                <span class="val">5432 lbs.</span>
              </li>
              <li class="line1">
                <span class="key">Gross Weight :</span>
                <span class="val">6724 lbs.</span>
              </li>
              <li class="line0">
              ...
              <li class="line1">
                ...
                <span class="val">67.5 in.</span>
              </li>
              <li class="line0">
                <span class="key">Length :</span>
                <span class="val">195.31 in.</span>
              </li>
              <li class="line1">
                <span class="key">Width :</span>
                <span class="val">79.2 in.</span>
              </li>
              <li class="line0">
                <span class="key">Boot Space :</span>
                <span class="val">650 liters</span>
              </li>
            </ul>
        </div>
      </div>
